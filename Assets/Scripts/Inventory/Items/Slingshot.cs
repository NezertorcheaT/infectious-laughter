...
namespace Inventory.Items
{
    ...
    public class Slingshot : ScriptableObject, IUsableItem, ICanSpawn
    {
        ...
        {            
            ...
            var spawner =
                Verifier.Container.InstantiatePrefab(SpawnerPrefab, entity.transform.position, Quaternion.identity, null);
            ...
            spawner.GetComponent<SlingshotAnimationController>().
                Initialize(slingshotImpact, entity.transform.GetComponent<Animator>(), chargeTime);
