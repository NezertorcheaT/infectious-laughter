...
namespace Editor.EditorAI
{
    public class StateNodeView : Node
    {
        ...
        public StateNodeView(StateTree.StateForList state, IStateTree<State> tree)
        {
            State = state;
            Tree = tree;
        ...
        public override void SetPosition(Rect newPos)
        {
            ...
            (Tree as IGlobalParameterNodeStateTree<State, Tuple<Vector2>>)?.TrySetParameters(State.id, new Tuple<Vector2>(new Vector2(newPos.xMin, newPos.yMin)));
        }
    }
}